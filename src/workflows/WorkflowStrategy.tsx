...
export function WorkflowStrategy({strategy,channels,gates,open,toggle}:{strategy:Record<string,unknown>;channels:Record<string,unknown>;gates:Record<string,unknown>;open:boolean;toggle:()=>void}) {
