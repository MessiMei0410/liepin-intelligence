...
MOTION_KEYS = ["直线电机", "光栅尺", "丝杠", "导轨", "轴承", "运动台", "工件台", "气浮轴承"]
# 六自由度精密运动台（6-DOF 工件台/对准台）：2026-08-19 客户新增要求，整机级大加分项
STAGE_KEYS = ["六自由度", "6自由度", "6-dof", "6dof", "运动台", "工件台", "气浮台", "气浮轴承", "多轴联动", "对准台", "精密运动平台"]
HARD_KEYS_DEFAULT = HARD_KEYS_DEFAULT + STAGE_KEYS
