...
export const overviewWorkbench: Workbench = {
  ok: true, version: 'fixture-v1', summary: { pending: 4, running: 1, delivered: 2, total: 7, decision: 4, waiting_client: 0, risk: 0 },
  items: [
    { item_key: 'approval:1', source_revision: '1', kind: 'approval', lane: 'decision', priority_score: 20000, title: '示例客户甲｜运动控制负责人｜第2轮寻访', subtitle: '执行多渠道寻访', status_label: 'R3 待审批', reason: '外部动作需由顾问单次确认', source_label: '审批', updated_at: '2026-08-03 09:30:00', inbox_state: 'unread', primary_action: { type: 'open_workflow', id: 'workflow_fixture_01', label: '查看并审批' } },
    { item_key: 'candidate:9105', source_revision: '1', kind: 'candidate_action', lane: 'decision', priority_score: 15000, title: '候选人戊', subtitle: '示例客户戊 / 失效分析工程师', status_label: '已回复', reason: '候选人回复，希望进一步了解团队与汇报线', source_label: '人选推进', updated_at: '2026-08-03 09:20:00', inbox_state: 'unread', primary_action: { type: 'open_candidate', id: '9105', label: '处理候选人回复' } },
    { item_key: 'candidate:9102', source_revision: '1', kind: 'candidate_action', lane: 'decision', priority_score: 11000, title: '候选人乙', subtitle: '示例客户乙 / 精密机械专家', status_label: '待复核', reason: '新增简历，等待人工复核推进方向', source_label: '人选推进', updated_at: '2026-08-03 09:10:00', inbox_state: 'unread', primary_action: { type: 'open_candidate', id: '9102', label: '人工复核' } },
    { item_key: 'candidate:9104', source_revision: '1', kind: 'candidate_action', lane: 'decision', priority_score: 9000, title: '候选人丁', subtitle: '示例客户丁 / 软件架构师', status_label: '待联系', reason: '复核通过，等待顾问人工联系', source_label: '人选推进', updated_at: '2026-08-03 08:55:00', inbox_state: 'unread', primary_action: { type: 'open_candidate', id: '9104', label: '查看人选' } },
