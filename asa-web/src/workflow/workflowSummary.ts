...
export const workflowCandidateItemSchema = z.looseObject({
  ...
  attribution: z.looseObject({
    ...
    candidate_index: z.number().nullish(),
    from_workflow: z.boolean().optional(),
  }).nullish(),
  source_lineage: z.array(z.looseObject({
    source_type: z.string(), workflow_id: z.string().optional(), artifact_id: z.string().optional(),
    candidate_index: z.number().nullish(), channel: z.string().optional(), source_query: z.string().optional(),
    source_round: z.string().optional(), query_cell_id: z.string().optional(),
  })).optional(),
